        ...
        {isHome ? (
          <>
            ...
            <h1 style={{ fontFamily: "'Gveret Levin', cursive", fontSize: 40, fontWeight: 400, lineHeight: 1.2, marginBottom: 14, maxWidth: 320, marginInline: "auto" }}>
              <span style={{ display: "block", textAlign: "right", paddingInlineStart: "15%" }}>כל הצמחים,</span>
              <span style={{ display: "block", textAlign: "left", paddingInlineEnd: "15%" }}>במקום אחד.</span>
            </h1>
