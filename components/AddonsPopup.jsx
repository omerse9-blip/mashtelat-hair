...
// הקוביות ב-90% ממה שהיו (0.81 × 0.9 = 0.729), הרשת ממורכזת כך שהחלון עצמו נשאר באותו רוחב
const cardGrid = { display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 0.729fr))", gap: 10, alignItems: "stretch", justifyContent: "center" };
